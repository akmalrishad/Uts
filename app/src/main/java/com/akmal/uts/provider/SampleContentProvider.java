...
package com.akmal.uts.provider;
...
import com.akmal.uts.data.Cheese;
import com.akmal.uts.data.CheeseDao;
import com.akmal.uts.data.SampleDatabase;
    ...
    public ContentProviderResult[] applyBatch(
        ...
        return database.runInTransaction(new Callable<ContentProviderResult[]>() {
            ...
            public ContentProviderResult[] call() throws OperationApplicationException {
                return com.akmal.uts.provider.SampleContentProvider.super.applyBatch(operations);
            }
        });
    }
